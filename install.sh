...
install -m644 src/modules/flatpak.py "$SHARED_DIR/modules/flatpak.py"
install -m644 src/modules/config.py "$SHARED_DIR/modules/config.py"
install -m644 src/modules/system.py "$SHARED_DIR/modules/system.py"